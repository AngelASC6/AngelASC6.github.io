...
export default function Header() {
  ...
  return (
    <div className="bg-gradient-to-r from-green-700 to-green-900 flex items-center justify-between border border-slate-600 px-4 h-14 fixed top-0 left-0 right-0 z-30 shadow-md w-full">
      {/* Profile Container */}
      <div id="profile-container" className="p-1 flex items-center">
        <img
      ...
      <div
        id="nav-options"
        className="hidden md:flex space-x-4 p-2 rounded text-neutral-100"
      >
      ...
      <div
        ...
        } md:hidden absolute top-0 right-0 left-0 text-black p-4 rounded shadow-lg bg-[#012813] transition-transform duration-300 ease-in-out`}
      >
