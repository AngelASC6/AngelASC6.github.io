...
export default function Billboard() {
  ...
  useEffect(() => {
    document.fonts.ready.then(() => {
      ...
      const { words: subtitleWords } = splitText(
        document.querySelector("#billboard-subtitle")
      );
  ...
  return (
    ...
    >
      <h1
        className="text-5xl sm:text-7xl md:text-9xl font-light text-[#1A1A1A] tracking-wide opacity-85"
        id="billboard-text"
      >
        Hey, I'm Angel!
      </h1>
      ...
      <br />
      <span
        className="text-lg sm:text-2xl md:text-3xl text-gray-800 opacity-85 font-light tracking-wide"
        id="billboard-subtitle"
      >
