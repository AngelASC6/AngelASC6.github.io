  ...
  return (
    <footer className="bg-[#2D4137] text-white text-center p-4 grid grid-cols-3 font-['Roboto_Condensed']">
      <div className="col-span-1">
        <h2 className="md:text-3xl text-xl">Angel Vasquez</h2>
      </div>
      <div className="col-span-1 flex flex-col">
        <h2 className="md:text-3xl text-xl">Explore</h2>
        <div className="flex flex-col md:text-xl text-lg">
      ...
      <div className="col-span-1 flex flex-col">
        <h2 className="md:text-3xl text-xl">Social Media</h2>
        <div className="flex flex-col md:text-xl text-lg">
